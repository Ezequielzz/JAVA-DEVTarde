...
public class VendasControl {
    ...
    private void atualizarTabela() {
        ...
        for (Vendas venda : vendas) {
            ...
            if (venda.getProduto().equals("") && venda.getCodigo().equals("") && venda.getValorUnit().equals("") && venda.getQuantidade().equals("")) {
    ...
    public void vender(String produto, String codigo, String valorUnit, String quantidade) {
        new VendasDAO().vender(produto, codigo, valorUnit, quantidade);
