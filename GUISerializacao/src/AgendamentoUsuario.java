...
public class AgendamentoUsuario extends JPanel{
    //atributos
    ...
    public AgendamentoUsuario() {
        ...
        atualizarAgendaButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                operacoes.atualizarAgendamento(linhaSelecionada, inputData.getText(), inputHora.getText(),comboUsuarios.getSelectedItem(),inputDescricao.getText());
            }
        });
